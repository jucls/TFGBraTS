...
Por otro lado, se explorará la unificación de la segmentación y predicción en una única arquitectura con el objetivo de aumentar la generalización gracias a la multi-tarea.
