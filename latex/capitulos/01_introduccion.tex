...
Definiremos como nuestro conjunto de datos $X$ a un conjunto de resonancias magnéticas cerebrales completas.
...
\begin{enumerate}
	\item \textbf{Poca densidad de pruebas médicas.} A pesar de que la densidad de casos es alta, en magnitud es frecuente que la cantidad de pruebas que se realizan sea mucho más baja. 
	...
	\item \textbf{No existe una fuerte centralización de datos}. Al igual que los avances en imagen médica. 
\end{enumerate}
 para  ya que supone  para poder conservar su privacidad (eliminación de cualquier identificativo en las )

\subsection{Arquitectura propuesta}

** Explicar profundamente cuando lo tenga claro **

Unificación de las 3 tareas en un transformer. Uso de GAN para aumento de datos... E intentar unificarlo. Ir en contra un poco del estado del arte por no usar una arquitectura basada en convoluciones es frecuente el uso de U-nets.
